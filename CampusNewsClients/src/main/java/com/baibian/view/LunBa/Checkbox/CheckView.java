...
class CheckView extends View implements Checkable {
    ...
    private void init(AttributeSet attrs) {
        ...
        int tickColor = ta.getColor(R.styleable.CheckBox_diy_colorTick, COLOR_TICK);
        mAnimDuration = ta.getInt(R.styleable.CheckBox_diy_duration, DEF_ANIM_DURATION);
        mFloorColor = ta.getColor(R.styleable.CheckBox_diy_colorUncheckedStroke, COLOR_FLOOR_UNCHECKED);
        mCheckedColor = ta.getColor(R.styleable.CheckBox_diy_colorChecked, COLOR_CHECKED);
        mUnCheckedColor = ta.getColor(R.styleable.CheckBox_diy_colorUnchecked, COLOR_UNCHECKED);
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.CheckBox_diy_strokeWidth, dp2px(getContext(), 0));
        mShape = ta.getInt(R.styleable.CheckBox_diy_shape, 0);
        ta.recycle();
